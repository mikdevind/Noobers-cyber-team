...
if (isset($_POST["konversi"])) {
	...
	if($aksi == "m2f"){
        $hasil2 = $jarak / (4 * $frekuensi);
        $hasil =  43.3 * sqrt($hasil2);
        $hasil = $hasil . " Feet";
        $jarak = $jarak . " Miles";
        $frekuensi = $frekuensi . " GHz";
    }elseif($aksi == "km2m"){
        $jarak2 = $jarak / 1.609344;
        $hasil2 = $jarak2 / (4 * $frekuensi);
        $hasil = 43.3 * sqrt($hasil2);
        $hasil = $hasil * 0.3048;
        $hasil = $hasil . " M";
        $jarak = $jarak . " KM";
                            ...
                            <form method="post" action="">
                                <table border="0" cellspacing="0" cellpadding="5">
                                    <tr>
                                        ...
                                        <td> : </td>
                                        <td>
                                            <input class="input" name="jarak" type="number" required/>
                                            <div class="garis"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td> : </td>
                                        <td>
                                            <input class="input" name="frekuensi" type="number" value="2.412" required/>
                                            <div class="satuan">GHz</div>
                                            <div class="garis"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select id="akhir" name="aksi">
                                                <option value="m2f" selected>Miles ke Feet</option>
                                                <option value="km2m">KM ke M</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
